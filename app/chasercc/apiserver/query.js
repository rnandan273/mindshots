...
async function main() {
    try {
        ...
        // const result = await contract.evaluateTransaction('queryEAL','Tom');
        const result = await contract.evaluateTransaction('queryEals','','');
        console.log(`Transaction has been evaluated, result is: ${result.toString()}`);

        //const result1 = await contract.evaluateTransaction('queryUserEals','raghu');
        //console.log(`Transaction has been evaluated, result is: ${result1.toString()}`);
        const result2 = await contract.evaluateTransaction('queryEal','eal-sl-001-8');
